"""VIP (CQVIP) source with PDF priority and human-like behavior."""
...
class VIPSource(BrowserSource):
    """VIP (维普) academic source with browser automation.
        ...
        try:
            ...
            for idx, item in enumerate(items):
                ...
                try:
                    ...
                    print(f"Error parsing VIP result {idx}: {e}")
                    continue
    ...
    def _extract_source_info(self, item) -> tuple:
        ...
        date_elem = item.select_one(".date, .year")
        if date_elem:
